import { cn } from "@/lib";
import { ArrowRightIcon, FramerIcon, Code } from "lucide-react";
...
const SOCIAL_PLATFORMS = [
  { icon: Icons.shopify, position: "left-3", size: "small", iconSize: "small", className: "hidden lg:flex" },
  { icon: FramerIcon, position: "left-2", size: "medium", iconSize: "medium" },
  { icon: Icons.webflow, position: "left-1", size: "large", iconSize: "large" },
  { icon: Code, position: "right-1", size: "large", iconSize: "large" },
  { icon: Icons.wordpress, position: "right-2", size: "medium", iconSize: "medium" },
  { icon: Icons.squarespace, position: "right-3", size: "small", iconSize: "small", className: "hidden lg:flex" },
];
      ...
      <Container className="relative">
        <div className="relative flex flex-col lg:hidden items-center justify-center overflow-visible">
          ...
          <div className="max-w-sm w-full h-auto mx-auto mt-8">
            <Image src="/images/integration.svg" alt="Integration" width={1000} height={1000} className="w-full h-auto" />
          </div>
        </div>
      </Container>

      <div className="flex flex-col items-center text-center max-w-3xl mx-auto lg:absolute lg:top-1/4 inset-x-0 mt-12 lg:mt-0">
        <h2 className="text-2xl md:text-4xl lg:text-6xl font-heading font-semibold !leading-snug">Integration</h2>
      </div>
