  ...
  return (
    <div className="relative flex flex-col items-center justify-center w-full py-3">
      ...
      <div className="flex flex-col items-center justify-center gap-y-8 relative">
        ...
        <div className="flex flex-col items-center justify-center text-center gap-y-4 bg-background/0 z-5">
          <Container delay={0.15}>
            <h1 className="text-4xl md:text-4xl lg:text-7xl xl:text-[5rem] font-bold text-center !leading-tight max-w-5xl mx-auto">
              Innovate and <span className="">Grow </span>
              with your users <AuroraText>feedback</AuroraText>
            </h1>
          </Container>
          <Container delay={0.2}>
            <p className="max-w-xl mx-auto mt-2 text-base lg:text-lg text-center text-muted-foreground">
              Get valuable insights about your product from people who are using it - Your users.
            </p>
          </Container>
